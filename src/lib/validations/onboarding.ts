...
}).refine(v => v.preferred_salary_min === null || v.preferred_salary_max === null || v.preferred_salary_max >= v.preferred_salary_min, "Maximum salary must be at least the minimum salary.");
