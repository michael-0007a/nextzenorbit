/**
 * Admin Cover Letter Generator Page
 *
 * Route: /admin/users/[id]/generate-cover-letter
 * Allows admin to generate a cover letter for a user based on their base resume
 * and a job description. The generated cover letter is saved as an admin_cover_letter.
 */

import { createAdminClient } from "@/lib/supabase/admin";
import { requireAdmin, isAuthError } from "@/lib/admin/guards";
import { redirect } from "next/navigation";
import { AdminCoverLetterGeneratorClient } from "./client";
...
export default async function AdminCoverLetterGeneratorPage({ params }: Props) {
